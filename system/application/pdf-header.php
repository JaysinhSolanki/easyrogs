...
<table class="tabela1" style="border:none !important; font-size:1.09em !important; font-family:timesnewroman; line-height: 20px ">
    <tr>
        <th colspan="2">
            <h2 align="center"></h2>
        </th>
...
?>
    <table class="tabela1" style="border:none !important;overflow: wrap">
        ...
        <tr>
            <td colspan="2" align="center">
                <h3><u>PRELIMINARY STATEMENT</u></h3>
            </td>
        </tr>
    </table>
    ...
    ?>
        <div class="instruction-leading"> <?= html_entity_decode($instructions) ?> </div>
        <?php
    } else {
        ...
        ?>
            ...
            if ($personnames1) {
            ?>
                <p>(d) EMPLOYEE means a PERSON who provides services in an EMPLOYMENT relationship and who is a party to this lawsuit. For purposes of these interrogatories, EMPLOYEE refers to <?php echo $personnames1;
                                                                                                                                                                                                    if (substr($personnames1, -1) != '.') {
                                                                                                                                                                                                        echo ".";
                                                                                                                                                                                                    } ?> </p>
            <?php
            } else {
            ...
            if ($personnames2) {
            ?>
                <p>(e) EMPLOYER means a PERSON who employs an EMPLOYEE to provide services in an EMPLOYMENT relationship and who is a party to this lawsuit. For purposes of these interrogatories, EMPLOYER refers to <?php echo $personnames2;
                                                                                                                                                                                                                        if (substr($personnames2, -1) != '.') {
                                                                                                                                                                                                                            echo ".";
                                                                                                                                                                                                                        } ?></p>
            <?php
            } else {

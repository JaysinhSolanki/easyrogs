...
function partyEmailAddrs($clientId)
{
	global $AdminDAO, $case_id;
	_assert([$case_id, $clientId]);
	$rows = $AdminDAO->getrows(
		'attorney a,client_attorney c_a',
		"*",
														...
														<td align="center">
															<div class="dropdown">
																...
																<ul class="dropdown-menu dropdown-menu-right" role="menu">
																	...
																	?>
																		<!-- 1:view -->
																		<li class="list-menu"><a href="javascript:" onclick="selecttab('49_tab','view.php?pid=<?= $case_id ?>&id=<?= $discovery['uid'] ?>&view=<?= Discovery::VIEW_PROPOUNDING ?>&response_id=0','49');"><i class="fa fa-eye"></i> View</a></li>
																	<?php
																	}
																	if (in_array("respond", $discovery_ACL)) {
																	?>
																		<!-- 1:respond -->
																		<li class="list-menu"><a href="javascript:" onclick="selecttab('49_tab','discoverydetails.php?pid=<?= $case_id ?>&id=<?= $discovery['uid'] ?>&view=<?= Discovery::VIEW_RESPONDING ?>&respond=<?= Discovery::TYPE_EXTERNAL ?>&response_id=0','49');"><i class="fa fa-edit"></i> Respond</a></li>
																	<?php
																	}
																	if (in_array("edit", $discovery_ACL)) {
																	?>
																		<!-- 1:edit -->
																		<li class="list-menu"><a href="javascript:" onclick="selecttab('47_tab','discovery.php?pid=<?= $case_id ?>&id=<?= $discovery['id'] ?>&supp=0','47');"><i class="fa fa-edit"></i> Edit</a></li>
																	<?php
																	}
																	if (in_array("request-pdf", $discovery_ACL)) {
																	?>
																		<!-- 1:pdf -->
																		<li class="list-menu"><a href="makepdf.php?id=<?= $discovery['uid'] ?>&view=<?= Discovery::VIEW_PROPOUNDING ?>" target="_blank"><i class="fa fa-file-pdf-o"></i> PDF</a></li>
																	<?php
																	}
																	if (in_array("delete", $discovery_ACL)) {
																	?>
																		<!-- 1:delete -->
																		<li class="list-menu"><a href="javascript:" onclick="doAction('delete','discovery','<?= $discovery['uid'] ?>');"><i class="fa fa-trash"></i> Delete</a></li>
																	<?php
																	}
																	?>
																</ul>
															...
															<td align="center">
																<div class="dropdown">
																	...
																	<ul class="dropdown-menu dropdown-menu-right" role="menu">
																		...
																		?>
																			<!-- 2:view -->
																			<li class="list-menu"><a href="javascript:" onclick="selecttab('49_tab','view.php?pid=<?= $case_id ?>&id=<?= $discovery['uid'] ?>&view=<?= Discovery::VIEW_RESPONDING ?>&response_id=<?= $response_id ?>','49');"><i class="fa fa-eye"></i> View</a></li>
																		<?php
																		}
																		if (in_array("edit", $response_ACL)) {
																		?>
																			<!-- 2:edit -->
																			<li class="list-menu"><a href="javascript:" onclick="selecttab('49_tab','discoverydetails.php?pid=<?= $case_id ?>&id=<?= $discovery['uid'] ?>&view=<?= Discovery::VIEW_RESPONDING ?>&respond=<?= Discovery::TYPE_EXTERNAL ?>&response_id=<?= $response_id ?>','49');"><i class="fa fa-edit"></i> Edit</a></li>
																		<?php
																		}
																		if (in_array("supp-amend", $response_ACL)) {
																		?>
																			<!-- 2:supp -->
																			<li class="list-menu"><a href="javascript:" onclick="selecttab('49_tab','discoverydetails.php?pid=<?= $case_id ?>&id=<?= $discovery['uid'] ?>&supp=1&view=<?= Discovery::VIEW_RESPONDING ?>&respond=<?= Discovery::TYPE_EXTERNAL ?>&response_id=<?= $response_id ?>','49');"><i class="fa fa-refresh"></i> Supp/Amend</a></li>
																		<?php
																		}
																		...
																		?>
																			<!-- 2:pdf/response -->
																			<li class="list-menu"><a href="makepdf.php?id=<?= $discovery['uid'] ?>&view=<?= Discovery::VIEW_RESPONDING ?>&response_id=<?= $response_id ?>" target="_blank"><i class="fa fa-file-pdf-o"></i> PDF</a></li>
																		<?php
																		}
																		if (in_array("unserve", $response_ACL)) {
																		?>
																			<!-- 2:unserve -->
																			<li class="list-menu"><a href="javascript:" onclick="doAction('unserve','response','<?= $response_id ?>');"><i class="fa fa-undo"></i> Unserve</a></li>
																		<?php
																		}
																		if (in_array("delete", $response_ACL)) {
																		?>
																			<!-- 2:delete -->
																			<li class="list-menu"><a href="javascript:" onclick="doAction('delete','response','<?= $response_id ?>');"><i class="fa fa-trash"></i> Delete</a></li>
																		<?php
																		}
														...
														<td align="center">
															<div class="dropdown">
																...
																<ul class="dropdown-menu dropdown-menu-right" role="menu">
																	...
																	?>
																		<!-- 3:add-response -->
																		<li class="list-menu"><a href="javascript:" onclick="selecttab('49_tab','discoverydetails.php?pid=<?= $case_id ?>&id=<?= $discovery['uid'] ?>&view=<?= Discovery::VIEW_RESPONDING ?>&respond=<?= Discovery::TYPE_INTERNAL ?>&response_id=0','49');"><i class="fa fa-edit"></i> Add response</a></li>
																	<?php
																	}
																	if (in_array("supp-amend", $discovery_ACL)) {
																	?>
																		<!-- 3:supp -->
																		<li class="list-menu"><a href="javascript:" onclick="selecttab('47_tab','discovery.php?pid=<?= $case_id ?>&id=<?= $discovery['id'] ?>&supp=1','47');"><i class="fa fa-refresh"></i> Supp/Amend</a></li>
																	<?php
																	}
																	...
																	?>
																		<!-- 3:redate -->
																		<li class="list-menu"><a href="javascript:" class="discovery-change-due-date" data-discovery-id="<?= $discovery['id'] ?>"><i class="fa fa-calendar-o"></i> Change Due Date</a></li>
																	<?php
																	}
																	if (in_array("unserve", $discovery_ACL)) {
																	?>
																		<!-- 3:unserve -->
																		<li class="list-menu"><a href="javascript:" onclick="doAction('unserve','discovery','<?= $discovery['uid'] ?>');"><i class="fa fa-undo"></i> Unserve</a></li>
																	<?php
																	}
																	if (in_array("delete", $discovery_ACL)) {
																	?>
																...
																<td align="center">
																	<div class="dropdown">
																		...
																		<ul class="dropdown-menu dropdown-menu-right" role="menu">
																			...
																			?>
																				<!-- 5:view -->
																				<li class="list-menu"><a href="javascript:" onclick="selecttab('49_tab','view.php?pid=<?= $case_id ?>&id=<?= $suppdiscovery['uid'] ?>&view=<?= Discovery::VIEW_PROPOUNDING ?>&response_id=0','49');"><i class="fa fa-eye"></i> View</a></li>
																			<?php
																			}
																			if (in_array("edit", $supp_discovery_ACL)) {
																			?>
																				<!-- 5:view -->
																				<li class="list-menu"><a href="javascript:" onclick="selecttab('47_tab','discovery.php?pid=<?= $case_id ?>&id=<?= $suppdiscovery['id'] ?>&supp=0','47');"><i class="fa fa-edit"></i> Edit</a></li>
																			<?php
																			}
																			if (in_array("respond", $supp_discovery_ACL)) {
																			?>
																				<!-- 5:respond -->
																				<li class="list-menu"><a href="javascript:" onclick="selecttab('49_tab','discoverydetails.php?pid=<?= $case_id ?>&id=<?= $suppdiscovery['uid'] ?>&view=<?= Discovery::VIEW_RESPONDING ?>&respond=<?= Discovery::TYPE_EXTERNAL ?>&response_id=0','49');"><i class="fa fa-edit"></i> Respond</a></li>
																			<?php
																			}
																			if (in_array("supp-amend", $supp_discovery_ACL)) {
																			?>
																				<!-- 5:supp -->
																				<li class="list-menu"><a href="javascript:" onclick="selecttab('47_tab','discovery.php?pid=<?= $case_id ?>&id=<?= $suppdiscovery['id'] ?>&supp=1','47');"><i class="fa fa-refresh"></i> Supp/Amend</a></li>
																			<?php
																			}
																			...
																			?>
																				<!-- 5:redate -->
																				<li class="list-menu"><a href="javascript:" class="discovery-change-due-date" data-discovery-id="<?= $suppdiscovery['id'] ?>"><i class="fa fa-calendar-o"></i>Change Due Date</a></li>
																			<?php
																			}
																			if (in_array("unserve", $supp_discovery_ACL)) {
																			?>
																				<!-- 5:unserve -->
																				<li class="list-menu"><a href="javascript:" onclick="doAction('unserve','discovery','<?= $suppdiscovery['uid'] ?>');"><i class="fa fa-undo"></i> Unserve</a></li>
																			<?php
																			}
																			if (in_array("delete", $supp_discovery_ACL)) {
																			?>
																				<!-- 5:delete -->
																				<li class="list-menu"><a href="javascript:" onclick="doAction('delete','discovery','<?= $suppdiscovery['uid'] ?>');"><i class="fa fa-trash"></i> Delete</a></li>
																			<?php
																			}
																			?>
																		</ul>
																	...
																	<td align="center">
																		<div class="dropdown">
																			...
																			<ul class="dropdown-menu dropdown-menu-right" role="menu">
																				...
																				?>
																					<!-- 6:view -->
																					<li class="list-menu"><a href="javascript:" onclick="selecttab('49_tab','view.php?pid=<?= $case_id ?>&id=<?= $suppdiscovery['uid'] ?>&view=<?= Discovery::VIEW_RESPONDING ?>&response_id=<?= $response_id ?>','49');"><i class="fa fa-eye"></i> View</a></li>
																				<?php
																				}
																				if (in_array("edit", $supp_response_ACL)) {
																				?>
																					<!-- 6:edit -->
																					<li class="list-menu"><a href="javascript:" onclick="selecttab('49_tab','discoverydetails.php?pid=<?= $case_id ?>&id=<?= $suppdiscovery['uid'] ?>&view=<?= Discovery::VIEW_RESPONDING ?>&respond=<?= Discovery::TYPE_EXTERNAL ?>&response_id=<?= $response_id ?>','49');"><i class="fa fa-edit"></i> Edit</a></li>
																				<?php
																				}
																				if (in_array("supp-amend", $supp_response_ACL)) {
																				?>
																					<!-- 6:supp -->
																					<li class="list-menu"><a href="javascript:" onclick="selecttab('49_tab','discoverydetails.php?pid=<?= $case_id ?>&id=<?= $suppdiscovery['uid'] ?>&supp=1&view=<?= Discovery::VIEW_RESPONDING ?>&respond=<?= Discovery::TYPE_EXTERNAL ?>&response_id=<?= $response_id ?>','49');"><i class="fa fa-refresh"></i> Supp/Amend</a></li>
																				<?php
																				}
...
<script>
	function doAction(action = 'delete', type = 'discovery', id) {
		console.assert(action in {
			'delete': 1,
			'unserve': 1
		}, 'Invalid `action` type specified')
		console.assert(type in {
			'discovery': 1,
			'response': 1
		}, 'Invalid discovery `type` specified`')
		swal({

            ...
            <div class="panel-body">
                <div class="panel panel-primary">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select  name="form_id" id="form_id"  <?php if ($id > 0) {
                                echo "disabled" ;
} if ($id < 1) {
?>onchange="loadformquestions(this.value,'<?php echo $discovery['id']?>'),callFunction(),loaddocsFunction(this.value)" <?php
                                ...
                                foreach ($forms as $thisrow) {
                                    ...
                                    <option <?php if ($thisrow['id']==$discovery['form_id']) {
                                        echo "selected";
}?> value="<?php echo $thisrow['id']?>"><?php echo $thisrow['form_name'];/*." (".$thisrow['short_form_name'].")"*/?></option>
                                    <?php
                                }
                                ?>
                            </select>
                            ...
                            <div  id="interogatoriesTypeDiv" <?php if ($id == '' || $discovery['in_conjunction'] == 0) {
                                ...
                                <div>
                                    <select  name="interogatory_type" id="interogatory_type"  class="form-control m-b">
                                        <option value="1" <?php if ($discovery['interogatory_type'] == 1) {
                                            echo "selected";
} ?>>GENERAL</option>
                                        <option value="2" <?php if ($discovery['interogatory_type'] == 2) {
                                            echo "selected";
} ?>>EMPLOYMENT</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="">
                                        <select  name="conjunction_setnumber" id="conjunction_setnumber"  class="form-control m-b" >
                                            ...
                                            for ($i=1; $i<=50; $i++) {
                                            ?>
                                            <option value="<?php echo $i; ?>" <?php if ($discovery['conjunction_setnumber'] == $i) {
                                                echo "selected";
} ?>><?php echo $i; ?></option>
                                            <?php
                                            }
...
?> loadpropondingattorneys('<?php echo $case_id; ?>',this.value,'<?php echo @$discovery['proponding_attorney']; ?>'),<?php
} ?>setquestionnumber(),loadrespondings('<?php echo $case_id; ?>',this.value,'<?php echo @$discovery['responding']; ?>')">
                                <?php
                    ...
                    ?>
                    <div class="form-group" id="start_questionid" <?php if (in_array(@$discovery['form_id'], array(1,2)) && $id > 0) {
                        echo "style='display:none'";
} ?>>

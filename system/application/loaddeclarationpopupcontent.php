...
$dec_state = $_REQUEST['dec_state'] ?: 'California';
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-danger" role="alert">
				...
				<i class="fa fa-university" aria-hidden="true" /> Code Civ.Proc., 2033.030 <?= instruction( 17 ) ?>, 2033.050 <?= instruction( 18 ) ?>.
            </div>
        </div>
...
?>
    <form name="formdeclaration" id="formdeclaration">
        ...
        <div class="form-group">
            ...
            ?></textarea>
            <br />
            <p>I declare under penalty of perjury under the laws of the State of California that the foregoing is true and
                correct<br>
                Executed on <?= date( 'F j, Y' ) ?> at <span id="citystate">
												<input type="text" name="dec_city" id="dec_city"
                                                       placeholder="Enter your city..." value="<?= $dec_city ?>" />,
												<input type="text" name="dec_state" id="dec_state" value="<?= $dec_state ?>" />
											</span>.</br>
        </div>
...
?>
        ...
        <div class="row">
            <div class="col-md-8" style="text-align:right">
                <i id="DEC_msgdiv" style="color:red" />
            </div>

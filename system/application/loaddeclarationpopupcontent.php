...
$propoundingdetails		=	$AdminDAO->getrows("clients","*","id = :id",array(":id"=>$propounding));
...
<div class="row">
    ...
    <div class="alert alert-danger" role="alert">
   		Sorry, an attorney must sign a Declaration for Additional Discovery. <br /><i class="fa fa-university" aria-hidden="true"></i> Code Civ.Proc., 2033.030 <?php  echo instruction(17) ?>, 2033.050 <?php  echo instruction(18) ?>.
    </div>
    </div> 
    <div class="col-md-12" style="text-align:right">
    <a type="button" class="btn btn-warning tooltipshow" onclick="serveFunctionMain(0);" data-placement="top" data-toggle="tooltip" data-original-title="Serve without signing DAD."><i class="fa fa-fast-forward" aria-hidden="true"></i> Skip</a>
...
<div class="col-md-4" style="text-align:right">
	<button type="button" class="btn btn-primary" onclick="signdeclaration('<?php echo $_REQUEST['pos_or_save']; ?>')"><i class="fa fa-pencil "></i> Sign</button>
    <a type="button" class="btn btn-warning tooltipshow" onclick="serveFunctionMain(0);" data-placement="top" data-toggle="tooltip" data-original-title="Serve without signing DAD."><i class="fa fa-fast-forward" aria-hidden="true"></i> Skip</a>
    <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-close"></i> Cancel</button>

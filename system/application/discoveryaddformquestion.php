...
<td style="vertical-align:middle; width:20%">
	...
	<input readonly="readonly" type="text"  name="question_numbers[]" id="question_numbers<?= $rand_id ?>"  placeholder="Question No." class="form-control m-b questionscls" >
</td>
<td style="vertical-align:middle">
	<textarea name="question_titles[]" id="question_titles<?= $rand_id ?>" placeholder="Enter Text Here"  class="form-control m-b question_titlecls" ></textarea>
</td>

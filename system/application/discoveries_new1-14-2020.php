									...
									<td align="center">
										<div class="dropdown">
											...
											<ul class="dropdown-menu dropdown-menu-right" role="menu">
												...
												{
												?>
													<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','view.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['d_uid']?>&response_id=0&view=1','49');"><i class="fa fa-eye"></i> View</a></li>
													<?php /*?><li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['d_uid']?>&view=1&respond=0','49');"><i class="fa fa-eye"></i> View</a></li><?php */?>
												<?php
												}
												...
												{
												?>
													<li><a href="javascript:;"  onclick="javascript: selecttab('47_tab','discovery.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['id']?>&supp=0','47');"><i class="fa fa-edit"></i> Edit</a></li>
												<?php
												}
												if(in_array("request-pdf",$discovery_ACL))
												{
												?>
													<li><a href="makepdf.php?id=<?php echo $discovery['d_uid'];?>&view=1" target="_blank"   ><i class="fa fa-file-pdf-o"></i> PDF</a></li>
												<?php
												}
										...
										<td align="center">
											<div class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right" role="menu">
													...
													{
													?>
														<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','view.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['d_uid']?>&view=0&response_id=<?php echo $response_id?>','49');"><i class="fa fa-eye"></i> View</a></li>
													<?php
													}
													if(in_array("edit",$response_ACL))
													{
													?>
														<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['d_uid']?>&view=0&respond=1&response_id=<?php echo $response_id?>','49');"><i class="fa fa-edit"></i> Edit</a></li>
													<?php
													}
													if(in_array("supp-amend",$response_ACL))
													{
													?>
														<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['d_uid']?>&supp=1&view=0&respond=1&response_id=<?php echo $response_id?>','49');"><i class="fa fa-refresh"></i> Supp/Amend</a></li>
													<?php
													}
													...
													{
													?>
														<li><a href="makepdf.php?id=<?php echo $discovery['d_uid'];?>&view=0&response_id=<?php echo $response_id?>" target="_blank" ><i class="fa fa-file-pdf-o"></i> PDF</a></li>
													<?php
													}
									...
									<td align="center">
										<div class="dropdown">
											...
											<ul class="dropdown-menu dropdown-menu-right" role="menu">
												...
												{
												?>
													<li><a href="<?php echo $ResponsePDF_FileName ?>" target="_blank" ><i class="fa fa-file-pdf-o"></i> PDF</a></li>
												<?php
												}
												if(in_array("request-pdf",$discovery_ACL))
												{
												?>
													<li><a href="<?php echo $RequestPDF_FileName ?>" target="_blank"   ><i class="fa fa-file-pdf-o"></i> PDF</a></li>
												<?php
												}
												if(in_array("delete",$discovery_ACL))
												{
										...
										<td align="center">
											<div class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right" role="menu">
													...
													?>
                                                    	<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['d_uid']?>&supp=1&view=0&respond=1&response_id=<?php echo $response_id?>','49');"><i class="fa fa-refresh"></i> Supp/Amend</a></li>
                                                    	<?php /*?><li><a href="javascript:;"  onclick="createResponseSupp('<?php echo $response_id?>','<?php echo $d_id?>');"><i class="fa fa-refresh"></i> Supp/Amend</a></li><?php */?>
													<?php
													}
													...
													{
													?>
														<li><a href="<?php echo $RequestPDF_FileName ?>"   ><i class="fa fa-file-pdf-o"></i> PDF</a></li>
													<?php
													}
													if(in_array("response-pdf",$response_ACL))
													{
											...
											<td align="center">
												<div class="dropdown">
													...
													<ul class="dropdown-menu dropdown-menu-right" role="menu">
														...
														{
														?>
															<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','view.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $suppdiscovery['d_uid']?>&response_id=0&view=1','49');"><i class="fa fa-eye"></i> View</a></li>
															<?php /*?><li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $suppdiscovery['d_uid']?>&view=1&respond=0','49');"><i class="fa fa-eye"></i> View</a></li><?php */?>
														<?php
														}
														if(in_array("edit",$supp_discovery_ACL))
														{
														?>
															<li><a href="javascript:;"  onclick="javascript: selecttab('47_tab','discovery.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $suppdiscovery['id']?>&supp=0','47');"><i class="fa fa-edit"></i> Edit</a></li>
														<?php
														}
														if(in_array("respond",$supp_discovery_ACL))
														{
														?>
															<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $suppdiscovery['d_uid']?>&view=0&respond=1&response_id=0','49');"><i class="fa fa-edit"></i> Respond</a></li>
														<?php
														}
												...
												<td align="center">
													<div class="dropdown">
														...
														<ul class="dropdown-menu dropdown-menu-right" role="menu">
															...
															{
															?>
																<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','view.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $suppdiscovery['d_uid']?>&view=0&response_id=<?php echo $response_id?>','49');"><i class="fa fa-eye"></i> View</a></li>
															<?php
															}
															if(in_array("edit",$supp_response_ACL))
															{
															?>
																<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $suppdiscovery['d_uid']?>&view=0&respond=1&response_id=<?php echo $response_id?>','49');"><i class="fa fa-edit"></i> Edit</a></li>
															<?php
															}
															if(in_array("supp-amend",$supp_response_ACL))
															{
															?>
                                                            	<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $suppdiscovery['d_uid']?>&supp=1&view=0&respond=1&response_id=<?php echo $response_id?>','49');"><i class="fa fa-refresh"></i> Supp/Amend</a></li>
																<?php /*?><li><a href="javascript:;"  onclick="createResponseSupp('<?php echo $response_id?>','<?php echo $supp_d_id?>');"><i class="fa fa-refresh"></i> Supp/Amend</a></li><?php */?>
															<?php
															}

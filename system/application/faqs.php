...
?>
						<div class="panel-body">
							<a data-toggle="collapse" data-parent="#accordion" href="#question-<?= $counter ?>" aria-expanded="false" class="collapsed faq-question">
								<i class="fa fa-chevron-down pull-right text-muted"></i>
								<?= $faqs['question'] ?>
							</a>
							<div id="question-<?= $counter ?>" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
								<hr>
<?php 

...
<div class="col-lg-12">
    <div class="hpanel">
        ...
        <div class="panel-body">
            ...
            <div class="row">
            	<div class="col-md-6">
                	<span style="font-size:18px; font-weight:600">Discoveries</span>
                </div>
                <div class="col-md-6" align="right">
                	<button  class="btn btn-default" onclick="javascript: selecttab('47_tab','discovery.php?pid=<?php echo $case_id;?>&type=1','47');"> <i class="fa fa-play fa-rotate-180"></i> To Serve <?php instruction(4) ?></button>
                	<button  class="btn btn-default" onclick="javascript: selecttab('47_tab','discovery.php?pid=<?php echo $case_id;?>&type=2','47');" style="margin-left:10px"> <i class="fa fa-play"></i> Served on Us <?php instruction(5) ?></button>
                </div>
            </div>
            </div>
            <div class="panel-body">
								...
								**/
								...
								<tr style="background-color:#18fd4736">
									...
									<a href="javascript:;" id="plusBtn<?php echo $d_id ?>"  onclick="showHide(1,'<?php echo $d_id ?>')">
										<img src="<?php echo ASSETS_URL."images/plus.png" ?>" width="20px" />
									</a>
									<a href="javascript:;" id="minusBtn<?php echo $d_id ?>" style="display:none" onclick="showHide(2,'<?php echo $d_id ?>')">
										<img src="<?php echo ASSETS_URL."images/minus.png" ?>" width="20px" />
									</a>
									</td>
									<td>
									<?php 
									...
									<td><?php echo dateformat($discovery['due'])?></td>
									<td>
									...
									<td align="center">
										<div class="dropdown">
											...
											<ul class="dropdown-menu dropdown-menu-right" role="menu">
												...
												{
												?>
													<li><a href="javascript:;"  onclick="javascript: selecttab('47_tab','discovery.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['id']?>&supp=0','47');"><i class="fa fa-edit"></i> Edit Request</a></li>
												<?php
												}
												if(in_array("respond",$discovery_ACL))
												{
												?>
													<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['d_uid']?>&view=0&respond=1&response_id=0','49');"><i class="fa fa-edit"></i> Respond</a></li>
												<?php
												}
												if(in_array("view",$discovery_ACL) || in_array("request-pdf",$discovery_ACL))
												{
													?>
													...
													{
													?>
														<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['d_uid']?>&view=1&respond=0','49');"><i class="fa fa-eye"></i> View Request</a></li>
													<?php
													}
													if(in_array("request-pdf",$discovery_ACL))
													{
													?>
														<li><a href="makepdf.php?id=<?php echo $discovery['d_uid'];?>&view=1" target="_blank"   ><i class="fa fa-file-pdf-o"></i> Request PDF</a></li>
													<?php
													}
												}
												...
												?>
													<hr style="margin-top:0px;margin-bottom:0px;">
													<li><a href="javascript:;"   onclick="javascript: buttondeletediscovery('<?php echo $discovery['d_uid']?>');"><i class="fa fa-trash"></i> Delete</a></li>
												<?php
												}
												?>
											</ul>
										...
										<td align="center">
											<div class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right" role="menu">
													...
													{
													?>
														<li><a href="javascript:;"  onclick="createResponseSupp('<?php echo $response_id?>','<?php echo $d_id?>');"><i class="fa fa-refresh"></i> Supp/Amend</a></li>
													<?php
													}
													...
													if(in_array("view",$response_ACL))
													{
														...
														{
														?>
															<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['d_uid']?>&view=1&respond=0&response_id=<?php echo $response_id?>','49');"><i class="fa fa-eye"></i> View Response</a></li>
														<?php
														}
													}
													if(in_array("edit",$response_ACL) || in_array("response-pdf",$response_ACL))
													{
														?>
														<hr style="margin-top:0px;margin-bottom:0px;">
														<?php
														...
														{
														?>
															<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['d_uid']?>&view=0&respond=1&response_id=<?php echo $response_id?>','49');"><i class="fa fa-edit"></i> Respond</a></li>
														<?php
														}
														if(in_array("response-pdf",$response_ACL))
														{
														?>
															<li><a href="makepdf.php?id=<?php echo $discovery['d_uid'];?>&view=0&response_id=<?php echo $response_id?>" target="_blank" ><i class="fa fa-file-pdf-o"></i> Response PDF</a></li>
														<?php
														}
													}
													...
													?>
														<hr style="margin-top:0px;margin-bottom:0px;">
														<li><a href="javascript:;"   onclick="javascript: buttondeleteresponse('<?php echo $response_id?>');"><i class="fa fa-trash"></i> Delete</a></li>
													<?php
													}
													?>
												</ul>
								...
								$supp_discoveries	=	$AdminDAO->getrows(
									...
									foreach($supp_discoveries as $suppdiscovery)
									{
										...
										**/
										...
										$supp_discovery_ACL[]	= "response-pdf";
										...
										<tr class="group_<?php echo $d_id ?>" style="display:none">
											...
											<td><?php echo dateformat($suppdiscovery['due'])?></td>
											...
											<td align="center">
												<div class="dropdown">
													...
													<ul class="dropdown-menu dropdown-menu-right" role="menu">
														...
														{
														?>
															<li><a href="javascript:;"  onclick="javascript: selecttab('47_tab','discovery.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $suppdiscovery['id']?>&supp=0','47');"><i class="fa fa-edit"></i> Edit Request</a></li>
														<?php
														}
														if(in_array("supp-amend",$supp_discovery_ACL))
														{
														?>
															<li><a href="javascript:;"  onclick="javascript: selecttab('47_tab','discovery.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $suppdiscovery['id']?>&supp=1','47');"><i class="fa fa-refresh"></i> Supp/Amend</a></li>
														<?php
														}
														
														if(in_array("view",$supp_discovery_ACL) || in_array("request-pdf",$supp_discovery_ACL))
														{
															?>
															<hr style="margin-top:0px;margin-bottom:0px;">
															<?php
															...
															{
															?>
																<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $suppdiscovery['d_uid']?>&view=1&respond=0','49');"><i class="fa fa-eye"></i> View Request</a></li>
															<?php
															}
															if(in_array("request-pdf",$supp_discovery_ACL))
															{
															?>
																<li><a href="makepdf.php?id=<?php echo $suppdiscovery['d_uid'];?>&view=1" target="_blank"   ><i class="fa fa-file-pdf-o"></i> Request PDF</a></li>
															<?php
															}
														}
														if(in_array("respond",$supp_discovery_ACL) || in_array("response-pdf",$supp_discovery_ACL))
														{
															?>
															<hr style="margin-top:0px;margin-bottom:0px;">
															<?php
															...
															{
															?>
																<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $suppdiscovery['d_uid']?>&view=0&respond=1','49');"><i class="fa fa-edit"></i> Respond</a></li>
															<?php
															}
															if(in_array("response-pdf",$supp_discovery_ACL))
															{
															?>
																<li><a href="makepdf.php?id=<?php echo $suppdiscovery['d_uid'];?>&view=0" target="_blank" ><i class="fa fa-file-pdf-o"></i> Response PDF</a></li>
															<?php
															}
														}
														...
														?>
															<hr style="margin-top:0px;margin-bottom:0px;">
															<li><a href="javascript:;"   onclick="javascript: buttondeletediscovery('<?php echo $suppdiscovery['d_uid']?>');"><i class="fa fa-trash"></i> Delete</a></li>
														<?php
														}
														?>
													</ul>
										...
										<?php
										/**
										* GET RESPONSES OF AMEND/SUPP INTERNAL DISCOVERY
										**/
									...
									<td align="center">
										<div class="dropdown">
											...
											<ul class="dropdown-menu dropdown-menu-right" role="menu">
												...
												{
												?>
													<li><a href="javascript:;"  onclick="javascript: selecttab('47_tab','discovery.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['id']?>&supp=1','47');"><i class="fa fa-refresh"></i> Supp/Amend</a></li>
												<?php
												}
												...
												if(in_array("respond",$discovery_ACL) || in_array("response-pdf",$discovery_ACL))
												{
													?>
													<hr style="margin-top:0px;margin-bottom:0px;">
													<?php
													...
													{
													?>
														<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['d_uid']?>&view=0&respond=1','49');"><i class="fa fa-edit"></i> Respond</a></li>
													<?php
													}
													if(in_array("response-pdf",$discovery_ACL))
													{
													?>
														<li><a href="makepdf.php?id=<?php echo $discovery['d_uid'];?>&view=0" target="_blank" ><i class="fa fa-file-pdf-o"></i> Response PDF</a></li>
													<?php
													}
												}
												if(in_array("delete",$discovery_ACL))
											...
											<div class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right" role="menu">
													...
													if(in_array("view",$response_ACL))
													{
														...
														{
														?>
															<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $discovery['d_uid']?>&view=1&respond=0&response_id=<?php echo $response_id?>','49');"><i class="fa fa-eye"></i> View Request</a></li>
														<?php
														}
													}
													if(in_array("edit",$response_ACL) || in_array("response-pdf",$response_ACL))
									...
									foreach($supp_discoveries as $suppdiscovery)
									{
										...
										**/
										if($supp_is_served == 1)
										{
											...
											/*if(in_array($_SESSION['loggedin_email'],$supp_respondingPartyAttr))
											{
												$supp_discovery_ACL[]	= "respond";
												$supp_discovery_ACL[]	= "response-pdf";
											}*/
													...
													<div class="dropdown">
														...
														<ul class="dropdown-menu dropdown-menu-right" role="menu">
															...
															if(in_array("view",$supp_response_ACL))
															{
																...
																{
																?>
																	<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $suppdiscovery['d_uid']?>&view=1&respond=0&response_id=<?php echo $response_id?>','49');"><i class="fa fa-eye"></i> View Request</a></li>
																<?php
																}
															}
															if(in_array("edit",$supp_response_ACL) || in_array("response-pdf",$supp_response_ACL))
															{
																?>
																<hr style="margin-top:0px;margin-bottom:0px;">
																<?php
																...
																{
																?>
																	<li><a href="javascript:;"   onclick="javascript: selecttab('49_tab','discoverydetails.php?pid=<?php echo $_GET['pid'];?>&id=<?php echo $suppdiscovery['d_uid']?>&view=0&respond=1&response_id=<?php echo $response_id?>','49');"><i class="fa fa-edit"></i> Respond</a></li>
																<?php
																}
																if(in_array("response-pdf",$supp_response_ACL))
																{
																?>
																	<li><a href="makepdf.php?id=<?php echo $suppdiscovery['d_uid'];?>&view=0&response_id=<?php echo $response_id?>" target="_blank" ><i class="fa fa-file-pdf-o"></i> Response PDF</a></li>
																<?php
																}
															}
...
{
	$.post( "responsesuppaction.php", { discovery_id: discovery_id,response_id: response_id}).done(function( case_id ) 
	{
		javascript: selecttab('45_tab','discoveries.php?pid='+case_id,'45');
		response('{"messagetype":2,"pkerrorid":7,"messagetext":"New Supp/Amend Response has been created successfully."}');
	});
}
